...
function init(){
    ...
    lewTex = THREE.ImageUtils.loadTexture("assets/textures/lew.jpg");
    lewTex.wrapS = lewTex.wrapT = THREE.RepeatWrapping;
    normalMaterial = new THREE.MeshBasicMaterial({
        map: lewTex,
        color: 0xffffff
    })
    var loader = new THREE.JSONLoader();
    loader.load( 'scripts/js/lew.json', function( geometry, materials ) {
        // geometry
